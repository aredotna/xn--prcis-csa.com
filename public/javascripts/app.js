(function(/*! Brunch !*/) {
  ...
  "views/index_view": function(exports, require, module) {
    (function() {
  var template,
...
(this.require.define({
  "views/shortcuts": function(exports, require, module) {
    (function() {
  var __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
...
(this.require.define({
  "views/templates/index": function(exports, require, module) {
...
(this.require.define({
  "views/templates/collection/slideshow": function(exports, require, module) {
    module.exports = function (__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
  ...
  (function() {
    (function() {
      ...
      if (this.block["class"] === 'Media') {
        ...
        __out.push(this.block.embed.html);
        __out.push('\n    </div>\n\n  ');
      } else if (this.block["class"] === 'Link') {
        __out.push('\n    <div class="link occupy">\n      <iframe src="');
        __out.push(__sanitize(this.block.source.url));
